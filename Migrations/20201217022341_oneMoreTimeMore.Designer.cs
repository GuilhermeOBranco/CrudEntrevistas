...
namespace ProjetoEstags.Migrations
{
    ...
    [Migration("20201217022341_oneMoreTimeMore")]
    partial class oneMoreTimeMore
    {
            ...
            modelBuilder.Entity("ProjetoEstags.Models.Entrevista", b =>
                {
                    ...
                    b.Property<int?>("IdEntrevistadoId")
                        .HasColumnType("int");

                    b.Property<int?>("IdEntrevistadorId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("IdEntrevistadoId");

                    b.HasIndex("IdEntrevistadorId");
            ...
            modelBuilder.Entity("ProjetoEstags.Models.Entrevista", b =>
                {
                    b.HasOne("ProjetoEstags.Models.Entrevistado", "IdEntrevistado")
                        .WithMany()
                        .HasForeignKey("IdEntrevistadoId");

                    b.HasOne("ProjetoEstags.Models.Entrevistador", "IdEntrevistador")
                        .WithMany()
                        .HasForeignKey("IdEntrevistadorId");
